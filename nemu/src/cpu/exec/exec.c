...
{
    if (width == 0) { width = decoding.is_operand_size_16 ? 2 : 4; }
...
make_group(gp1, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY)
    ...
    opcode_entry opcode_table[512] = {
        ...
        EMPTY,
        EMPTY,
        /* 0xb0 */ IDEXW(mov_I2r, mov, 1),
        IDEXW(mov_I2r, mov, 1),
        IDEXW(mov_I2r, mov, 1),
        IDEXW(mov_I2r, mov, 1),
        /* 0xb4 */ IDEXW(mov_I2r, mov, 1),
        IDEXW(mov_I2r, mov, 1),
        IDEXW(mov_I2r, mov, 1),
        IDEXW(mov_I2r, mov, 1),
        /* 0xb8 */ IDEX(mov_I2r, mov),
        IDEX(mov_I2r, mov),
        IDEX(mov_I2r, mov),
        IDEX(mov_I2r, mov),
        /* 0xbc */ IDEX(mov_I2r, mov),
        IDEX(mov_I2r, mov),
        IDEX(mov_I2r, mov),
        IDEX(mov_I2r, mov),
        /* 0xc0 */ IDEXW(gp2_Ib2E, gp2, 1),
        IDEX(gp2_Ib2E, gp2),
        EMPTY,
        EMPTY,
        /* 0xc4 */ EMPTY,
        ...
        EMPTY,
        EMPTY,
        /* 0xd0 */ IDEXW(gp2_1_E, gp2, 1),
        IDEX(gp2_1_E, gp2),
        IDEXW(gp2_cl2E, gp2, 1),
        IDEX(gp2_cl2E, gp2),
        /* 0xd4 */ EMPTY,
        EMPTY,
        EX(nemu_trap),
...
void exec_wrapper(bool print_flag)
{
    ...
    Log_write("%s\n", decoding.asm_buf);
    if (print_flag) { puts(decoding.asm_buf); }
#endif

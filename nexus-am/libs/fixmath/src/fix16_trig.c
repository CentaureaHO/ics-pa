...
fix16_t fix16_sin(fix16_t inAngle)
{
    ...
    if (_fix16_sin_cache_index[tempIndex] == inAngle) return _fix16_sin_cache_value[tempIndex];
#endif
...
fix16_t fix16_cos(fix16_t inAngle) { return fix16_sin(inAngle + (fix16_pi >> 1)); }

fix16_t fix16_tan(fix16_t inAngle) { return fix16_sdiv(fix16_sin(inAngle), fix16_cos(inAngle)); }
...
fix16_t fix16_acos(fix16_t x) { return ((fix16_pi >> 1) - fix16_asin(x)); }
...
fix16_t fix16_atan(fix16_t x) { return fix16_atan2(x, fix16_one); }
